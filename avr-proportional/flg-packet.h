...
#define  PACKET_STATE_UNIT1_WAIT 1
#define  PACKET_STATE_UNIT2_WAIT 2
#define  PACKET_STATE_ADDR_WAIT  3
#define  PACKET_STATE_DATA1_WAIT 4
#define  PACKET_STATE_DATA2_WAIT 5
#define  PACKET_STATE_TAIL_WAIT  6
...
typedef struct
{
  ...
  char all_off;
  char data[MAX_CHANNELS][2];
} tpacket;

// Handy debugging tools. Set during ISR, so check during main operation
// not completely isr-safe at the moment.
